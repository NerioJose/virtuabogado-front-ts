				...
				<div className="container mx-auto px-6 relative z-10">
					<motion.div
						...
						<p className="text-lg md:text-xl text-gray-700">
							Conoce las historias de éxito y experiencias de quienes han
							confiado en nuestros servicios legales.
						</p>
					</motion.div>
				</div>
			</section>
							...
							<motion.div
								...
								<div className="flex items-start gap-4 mb-4">
									...
									<div>
										...
										<p className="text-sm text-vinotinto mb-2">
											{testimonio.empresa}
										</p>
			...
			<section className="py-16 bg-azul-claro/20">
				<div className="container mx-auto px-6">
					<div className="text-center mb-12">
						...
						<p className="text-gray-600 max-w-2xl mx-auto">
							Algunos ejemplos de cómo hemos ayudado a nuestros clientes a
							resolver sus desafíos legales.
						</p>
					</div>
							...
							<motion.div
								...
								<div className="p-6">
									...
									<div className="flex items-center gap-2">
										...
										<p className="font-medium text-azul-primario">
											{caso.resultado}
										</p>
									</div>
								</div>
			...
			<section className="py-16 bg-white">
				<div className="container mx-auto px-6">
					<div className="text-center mb-12">
						...
						<p className="text-gray-600 max-w-2xl mx-auto">
							Organizaciones de diversos sectores que han elegido nuestros
							servicios legales.
						</p>
					</div>
				...
				<div className="container mx-auto px-6">
					<motion.div
						...
						<p className="text-gray-600 mb-8 max-w-2xl mx-auto">
							Únete a nuestra lista de clientes satisfechos y descubre cómo
							podemos ayudarte con tus necesidades legales.
						</p>
						<div className="flex flex-col sm:flex-row gap-4 justify-center">
							...
							<Link href="/servicios">
								<motion.button
									whileHover={{ scale: 1.05 }}
									whileTap={{ scale: 0.95 }}
									className="px-6 py-3 bg-white text-azul-primario border border-azul-primario rounded-xl hover:bg-azul-claro transition duration-300">
