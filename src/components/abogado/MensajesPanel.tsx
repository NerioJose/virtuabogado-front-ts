...
import { FiSearch, FiSend, FiPaperclip, FiUser, FiClock, FiMessageSquare } from 'react-icons/fi';
...
export default function MensajesPanel({ abogadoId }: MensajesPanelProps) {
      ...
      try {
        ...
        setConversaciones([
          ...
          },
          {
            ...
            ultimoMensaje: '¿Podríamos adelantar la cita para revisar los documentos?',
      ...
      const mensajesEjemplo: Mensaje[] = [
        {
          ...
          contenido: 'Buenos días, tengo algunas dudas sobre mi contrato laboral.',
        ...
        },
        {
          ...
          contenido: 'Buenos días María. Por supuesto, dígame qué dudas tiene y las revisaremos juntos.',
        ...
        },
        {
          ...
          remitente: 'María González',
          destinatario: 'Carlos Méndez',
          contenido: 'Principalmente me preocupa la cláusula de no competencia, ¿es legal que sea tan restrictiva?',
        ...
        },
        {
          ...
          remitente: 'Carlos Méndez',
          destinatario: 'María González',
          contenido: 'Tendría que revisar los detalles específicos. ¿Podría enviarme una copia del contrato para analizarlo?',
        ...
        },
        {
          ...
          remitente: 'Carlos Méndez',
          destinatario: 'María González',
          contenido: 'Perfecto. He revisado el documento y efectivamente hay algunos puntos que podríamos cuestionar. Le recomendaría que programemos una videollamada para discutirlo en detalle.',
        ...
        },
        {
          ...
          remitente: 'María González',
          destinatario: 'Carlos Méndez',
          contenido: 'Perfecto, a las 16:00h entonces. Gracias por la información proporcionada.',
  ...
  const enviarMensaje = () => {
    ...
    const nuevoMensajeObj: Mensaje = {
      ...
      remitente: 'Carlos Méndez',
      destinatario: conversaciones.find(c => c.id === conversacionActiva)?.participante || '',
  ...
  const formatearFecha = (fecha: string): string => {
    ...
    if (fechaObj.toDateString() === hoy.toDateString()) {
      ...
      return fechaObj.toLocaleDateString('es-ES', { day: '2-digit', month: '2-digit', year: '2-digit' });
    }
  };

  // Filtrar conversaciones por búsqueda
  const conversacionesFiltradas = conversaciones.filter(
    conv => conv.participante.toLowerCase().includes(busqueda.toLowerCase()) ||
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-900">{conv.participante}</h3>
                      {conv.caso && (
                ...
                <div className="mt-2 flex justify-between">
                  <p className="text-sm text-gray-600 truncate w-4/5">{conv.ultimoMensaje}</p>
                  {conv.noLeidos > 0 && (
        ...
        {conversacionActiva ? (
          <>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {mensajes.map((mensaje) => (
                <div 
                  key={mensaje.id}
                  className={`flex ${mensaje.remitente === 'Carlos Méndez' ? 'justify-end' : 'justify-start'}`}
                >
                  <div 
                  ...
                  >
                    ...
                    <div 
                      className={`text-xs mt-1 flex justify-end ${
                        mensaje.remitente === 'Carlos Méndez' ? 'text-azul-claro' : 'text-gray-500'
                      }`}
                    >
            ...
            <div className="p-4 border-t border-gray-200">
              <div className="flex items-center">
                <button className="p-2 text-gray-500 hover:text-azul-primario">
                  <FiPaperclip />
                </button>
                <input
                  type="text"
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              ...
              <h3 className="text-gray-900 font-medium">Selecciona una conversación</h3>
              <p className="text-gray-500 mt-1">Elige una conversación para ver los mensajes</p>
            </div>
          </div>
        )}
      </div>
