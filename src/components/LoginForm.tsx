...
const LoginForm: React.FC = () => {
	...
	const [rolSeleccionado, setRolSeleccionado] = useState('admin'); // Nuevo estado para seleccionar rol
	...
	return (
		<AuthLayout>
			<form
				...
				<Field>
					<Label>Rol para desarrollo</Label>
					<div className="flex space-x-4 mt-2">
						<label className="flex items-center">
							<input
								...
								onChange={() => setRolSeleccionado('admin')}
								className="mr-2"
							/>
							Administrador
						</label>
						<label className="flex items-center">
							<input
								...
								name="rol"
								value="abogado"
								checked={rolSeleccionado === 'abogado'}
								onChange={() => setRolSeleccionado('abogado')}
								className="mr-2"
							/>
							Abogado
						</label>
