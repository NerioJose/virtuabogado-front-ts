...
const InformacionContacto = React.memo(() => {
  ...
  const ContactInfoItem = React.memo(function ContactInfoItem({ info }: { info: ContactInfo }) {
    return (
      <div className="flex items-start gap-4">
        ...
        <div>
          <h3 className="text-lg font-semibold text-azul-primario">{info.title}</h3>
...
InformacionContacto.displayName = 'InformacionContacto';
