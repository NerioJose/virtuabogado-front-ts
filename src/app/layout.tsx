...
export const metadata: Metadata = {
	...
	keywords: ['abogado online', 'asesoría legal virtual', 'consultas legales', 'derecho peru', 'abogado digital', 'virtuabogado', 'servicios legales online', 'asesoría jurídica'],
