...
import {
	...
	markCartAsRecovered,
	clearCartData,
} from '../../lib/utils/cartRecovery';

export default function AbandonedCartReminder() {
	const [abandonedService, setAbandonedService] = useState<{
		nombre: string;
		descripcion: string;
					...
					<div className="bg-white rounded-lg shadow-xl overflow-hidden border border-azul-claro">
						...
						<div className="p-4">
							...
							<div className="bg-gray-50 p-3 rounded-md mb-4">
								<h4 className="font-medium text-azul-primario">
									{abandonedService.nombre}
								</h4>
								<p className="text-sm text-gray-600 mt-1">
									{abandonedService.descripcion}
								</p>
